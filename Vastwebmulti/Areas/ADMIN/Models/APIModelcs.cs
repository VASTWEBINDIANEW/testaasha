...
{
    public class APIModelcs
    {
        public IEnumerable<API_all_uesers_Result> ApiList { get; set; }
    }

    public class RchModelcs
    {
        ...
        [StringLength(10, MinimumLength = 10, ErrorMessage = "Pancard should only be 10 digits")]
        ...
        public IEnumerable<Select_show_RCH_Result> RCHList { get; set; }

        public Select_show_RCH_Result RCHUserBYID { get; set; }
        public IEnumerable<SelectListItem> RCHddlist { get; set; }
        public IEnumerable<Vastwebmulti.Models.proc_SelectAllFeeColletors_Result> feeCollectorsFC { set; get; }
        public proc_SelectAllFeeColletors_Result FCByID { get; set; }
