...
namespace Vastwebmulti.Areas.WMASTER.ViewModel
{
    public class FundTransferViewModel
    {
        ...
        public IEnumerable<spWhitelabel_select_admin_to_Dealer_Result> mastertodlmlist { get; set; }
        ...
        public IEnumerable<spWhitelabel_select_master_pur_order_Result> funrequesttoadmin { get; set; }

        public IEnumerable<spWhitelabel_select_dlm_pur_order_Result> FundRequestRecived { get; set; }

        public IEnumerable<spWhitelabel_Select_balance_Super_stokist_Result> FundRecievedDetails { get; set; }
