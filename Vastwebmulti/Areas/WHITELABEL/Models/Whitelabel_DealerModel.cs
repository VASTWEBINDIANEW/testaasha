...
{
    public class Whitelabel_DealerModel
    {
    ...
    public partial class Whitelabel_Select_Dealer_total_Result_model
    {
    ...
    public class Whitelabel_RetailerDetalsModel
    {
        ...
        public IEnumerable<Whitelabel_Select_Retailer_Details_all_Result> select_retailer_details { get; set; }
