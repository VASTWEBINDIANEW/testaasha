            ...
            using (VastwebmultiEntities db = new VastwebmultiEntities())
            {
                try
                {
                    ...
                    if (Email_passcodesmsonline == "Y")
                    {
                        ...
                        emailsend.EmailLimitChk(message.Destination, ToCC, message.Subject, message.Body, "No CallBackUrl");
                    }
        ...
        public Task SendAsync(IdentityMessage message)
        {
            ...
            System.Data.Entity.Core.Objects.ObjectParameter("Output", typeof(string));
                try
                {
                    ...
                    smssend.sms_init(SMS_passcodesmsonline.Status, SMS_passcodesmsonline.Whatsapp_Status, "SECURITYCODEIS", message.Destination, message.Body);
                }
                catch
                { }
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider =
                   ...
                   {
                       TokenLifespan = TimeSpan.FromDays(80)
                   };
            }
            return manager;
        }
