    ...
    public class NotificationHub : Hub
    {
        ...
        public void GetNotification()
        {
            try
            {
                ...
                List<Vastwebmulti.Models.Notification> totalNotifList = LoadNotifData(loggedUser);
                ...
                if (Users.TryGetValue(loggedUser, out receiver))
                {
                    ...
                    context.Clients.Client(cid).broadcaastNotif(totalNotifList);
                }
            }
            catch (Exception ex)
            {
        ...
        public void SendNotification(string SentTo)
        {
            ...
            {
                //Get TotalNotification
                List<Vastwebmulti.Models.Notification> totalNotifList = LoadNotifData(SentTo);
        ...
        private List<Vastwebmulti.Models.Notification> LoadNotifData(string userId)
        {
            //int total = 0;
